...
export const AboutAndImpactPage: React.FC<AboutAndImpactPageProps> = ({
  ...
  return (
    <div className="space-y-16 animate-fade-in pb-16">
      ...
      {/* Page Title Header */}
      <div className="bg-[#121824] py-12 border-b border-white/10 text-center">
        <div className="max-w-4xl mx-auto px-4 space-y-3">
          <span className="text-xs font-black uppercase tracking-widest text-[#00F0FF] bg-[#00F0FF]/15 px-3 py-1 rounded-full border border-[#00F0FF]/30">
