...
export const CareBotChat: React.FC = () => {
  ...
  const generateBotResponse = (userQuery: string): string => {
    ...
    if (q.includes('match') || q.includes('pair') || q.includes('choose') || q.includes('language')) {
      return 'PathPal pairs you based on your mobility requirements, primary language (English, Spanish, Cantonese, etc.), appointment location, and personal preferences. Pals meet you directly at the hospital entrance valet or lobby check-in.';
    }
