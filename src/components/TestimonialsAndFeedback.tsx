...
export const TestimonialsAndFeedback: React.FC<TestimonialsAndFeedbackProps> = ({ onOpenPalAccount }) => {
  ...
  return (
    <section id="feedback" className="py-24 bg-[#0A0D14] border-t border-white/10 relative overflow-hidden text-white">
      {/* Background Cyan Backlight */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-[#00F0FF]/5 rounded-full blur-[160px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#00F0FF]/10 border border-[#00F0FF]/30 text-[#00F0FF] text-xs font-bold uppercase tracking-[0.25em]">
            <Star className="w-4 h-4 fill-[#00F0FF]" />
          ...
          <h2 className="text-4xl sm:text-6xl font-black tracking-tight uppercase italic leading-none text-white">
            VOICES OF <br />
            <span className="text-[#00F0FF] text-stroke-cyan">CARE & GRATITUDE.</span>
          </h2>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-[#121824] p-4 rounded-2xl border border-white/10">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <button
              ...
              className="flex-1 md:flex-initial px-4 py-2.5 rounded-xl bg-[#00F0FF] text-black text-xs font-black uppercase tracking-wider hover:bg-[#00F0FF]/90 transition-all flex items-center justify-center gap-2 shadow-md shadow-[#00F0FF]/20"
            >
            ...
            <button
              ...
              className="flex-1 md:flex-initial px-4 py-2.5 rounded-xl bg-[#1A2232] border border-[#00F0FF]/30 text-[#00F0FF] text-xs font-bold uppercase tracking-wider hover:bg-[#00F0FF]/10 transition-all flex items-center justify-center gap-2"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {filteredFeedbacks.map((f) => (
            <div key={f.id} className="bg-[#121824] p-6 rounded-3xl border border-white/10 space-y-4 hover:border-[#00F0FF]/40 transition-all flex flex-col justify-between">
              ...
              <div className="pt-4 border-t border-white/10 space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <span className="bg-[#00F0FF]/10 text-[#00F0FF] text-[10px] font-bold px-2 py-0.5 rounded-full border border-[#00F0FF]/30">
                    {f.role}
                  </span>
                </div>
      ...
      {showSubmitModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in text-white">
          <div className="bg-[#121824] rounded-3xl max-w-lg w-full p-6 sm:p-8 border border-[#00F0FF]/40 shadow-2xl relative">
            <button
            ...
            {!submitted ? (
              <form onSubmit={handleFormSubmit} className="space-y-4">
                <div className="space-y-1">
                  <div className="text-xs font-bold uppercase text-[#00F0FF] tracking-widest">Feedback & Rating</div>
                  <h3 className="text-2xl font-black uppercase italic text-white">Rate Your Pal Companion</h3>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#1A2232] text-xs text-white p-3 rounded-xl border border-white/10 focus:border-[#00F0FF] focus:outline-none font-bold text-warm-gold"
                    >
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-xl bg-[#00F0FF] text-black font-black uppercase tracking-wider text-xs hover:bg-[#00F0FF]/90 shadow-md shadow-[#00F0FF]/20"
                >
                  Post Review & Rating
                </button>
              </form>
              ...
              <div className="text-center py-8 space-y-4">
                ...
                <h3 className="text-2xl font-black uppercase italic">Review Posted!</h3>
