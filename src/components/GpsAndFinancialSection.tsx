        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#121824] p-8 rounded-3xl border border-companion-coral/30 hover:border-companion-coral/60 transition-all space-y-6 flex flex-col justify-between shadow-2xl relative group">
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-300 leading-relaxed">
                Complete upfront transparency for both sides. Patients see exact plan charges, Medicare/insurance subsidies, and out-of-pocket costs. Pals see their hourly escort pay, CHW bonuses, and direct-deposit payouts.
              </p>

              <div className="space-y-2 text-xs">
                <div className="flex items-center gap-2 text-gray-300">
                  <CheckCircle2 className="w-4 h-4 text-companion-coral shrink-0" />
                  <span>Patient breakdown: $35 single visit or $0 with Medicare code G0511</span>
                </div>
                <div className="flex items-center gap-2 text-gray-300">
                  <CheckCircle2 className="w-4 h-4 text-companion-coral shrink-0" />
