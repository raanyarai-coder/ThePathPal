...
export const CalendarIntegrationModal: React.FC<CalendarIntegrationModalProps> = ({
  ...
  return (
    <div 
      ...
      aria-modal="true"
    >
      <div className="bg-[#121824] rounded-3xl border-2 border-[#00F0FF]/40 max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl relative text-white max-h-[90vh] overflow-y-auto">
        ...
        {/* User Role Banner */}
        {userRole === 'pal' ? (
          <div className="bg-[#1A2232] p-4 rounded-2xl border border-[#00F0FF]/30 flex items-start gap-3">
          ...
          <div className="bg-[#1A2232] p-4 rounded-2xl border border-white/10 flex items-start gap-3">
            <Bell className="w-5 h-5 text-companion-coral shrink-0 mt-0.5" />
            <div className="text-xs text-gray-200 leading-relaxed">
        ...
        <div className="space-y-4 bg-[#1A2232] p-5 rounded-2xl border border-white/10">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#121824] text-white border border-white/20 rounded-xl px-3.5 py-2.5 text-xs font-semibold focus:outline-none focus:border-[#00F0FF]"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#121824] text-white border border-white/20 rounded-xl px-3.5 py-2.5 text-xs focus:outline-none focus:border-[#00F0FF]"
            />
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            <label className="p-3 rounded-2xl bg-[#1A2232] border border-white/10 flex items-center justify-between cursor-pointer hover:border-white/30">
            ...
            <label className="p-3 rounded-2xl bg-[#1A2232] border border-[#00F0FF]/30 flex items-center justify-between cursor-pointer hover:border-[#00F0FF]">
          ...
          <div className="p-4 rounded-2xl bg-emerald-500/20 border border-emerald-500/50 text-emerald-300 text-xs flex items-center justify-between gap-2 animate-fade-in">
            ...
            {syncedUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="underline font-bold text-white hover:text-[#00F0FF] shrink-0"
              >
                View Event
              </a>
            )}
        ...
        {simulatedSmsSent && (
          <div className="p-3 rounded-xl bg-[#00F0FF]/20 border border-[#00F0FF]/50 text-[#00F0FF] text-xs flex items-center gap-2 animate-fade-in">
        ...
        <div className="pt-2 border-t border-white/10 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="bg-[#1A2232] hover:bg-white/10 text-white font-bold text-xs px-4 py-3 rounded-xl border border-white/20 transition-all flex items-center gap-2"
            >
            ...
            <button
              ...
              className="bg-[#00F0FF] hover:bg-[#00F0FF]/90 text-black font-black text-xs uppercase px-5 py-3 rounded-xl transition-all shadow-lg flex items-center gap-2"
            >
